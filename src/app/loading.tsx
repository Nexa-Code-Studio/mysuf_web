    ...
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm">
      <div className="relative flex flex-col items-center animate-in fade-in duration-300">
        ...
        <div className="relative flex items-center justify-center w-24 h-24 mb-6">
          ...
          <div className="absolute inset-0 rounded-full border-4 border-transparent border-t-[#e31837] border-l-[#e31837]/30 border-r-[#e31837]/30 animate-spin" />
        ...
        <div className="w-48 h-1.5 bg-slate-100 rounded-full mt-6 overflow-hidden">
          <div className="h-full bg-[#e31837] rounded-full animate-[loading_1.5s_ease-in-out_infinite]" 
